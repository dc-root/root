...
*/
var five = Number('5');
console.log( five + ' é número?', typeof five === 'number' ? "Sim" : "Não" ); // 5 é número? Sim

var concat = String(10) + String(10);
console.log( '"' + concat + '" é uma string? E é igual a "1010"?', typeof concat === 'string' ? "Sim" : "Não" ); // "1010" é uma string? E é igual a "1010"? Sim
...
if(!sum) {
    ...
    number1 = 10;
    number2 = 5;
    console.log(showOperationMessage(operationSignal), sum(number1, number2));
}
