...
sum((num1, num2) => { return num1 + num2 }); // 35
...
let subtraction = calculator(10, 5),
    multiplication = calculator(3, 5),
    division = calculator(100, 2),
    mod = calculator(15, 2);
...
subtraction((num1, num2) => { return (num1-num2) }); // 5

console.log( 'O resultado da multiplicação é:' );
multiplication((num1, num2) => { return (num1*num2) }); // 15

console.log( 'O resultado da divisão é:' );
division((num1, num2) => { return (num1/num2)}); // 50
